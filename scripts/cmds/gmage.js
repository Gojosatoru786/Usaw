...
module.exports = {
  ...
  onStart: async function ({ api, event, args }) {
    try {
      ...
      const apiKey = 'AIzaSyCX6Vbgpe2zzeNah02vC8Ba3iMwioCjQFE';
      const searchEngineID = '6416f92e1c1044ff4';
      ...
      const images = response.data.items.slice(0, 50); // Limit to the first 50 images
