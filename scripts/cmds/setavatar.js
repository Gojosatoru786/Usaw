...
module.exports = {
	config: {
      ...
      en: "{pn} [<image url> | <reply to text messages with pictures>] [<caption> | leave blank] [<expirationAfter (seconds)> | blank]"
      + "\nRespond to a message containing a photo with the content: {pn}"
      + "\nAttach a message containing a photo with the text: {pn}"
      + "\n\nNote"
      + "\n  + caption: caption will be included when changing avatar"
      + "\n  + expirationAfter: set temporary avatar mode (expires after expirationAfter(seconds))"
      + "\n For example:"
      + "\n   {pn} https://example.com/image.jpg: (changes avatar without caption, does not expire)"
